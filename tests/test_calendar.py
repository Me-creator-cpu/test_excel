...
def new_event(item):
    ...
    #options = st.selectbox(f"Filter values for event:", data_cours_niveau['niveau_txt'],index=True)
    options = st.selectbox(f"Filter values for event:", liste_niveaux,index=True)
