...
<<<<<<< HEAD
            dynsubtabs.append(data_menu_rootv2[v])
        dyn_tabs=st.tabs(','.join(dynsubtabs), on_change=on_dyntab_change, key="menuv2_tab")
=======
            st.write(v,data_menu_rootv2[v])
        dyn_tabs=st.tabs(data_menu_rootv2.items(), on_change=on_dyntab_change, key="menuv2_tab")
>>>>>>> d7120f3152622852b7390271e48d81aaa2c9c980
