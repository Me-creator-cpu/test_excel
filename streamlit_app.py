...
def build_table_dashboard(df):
    return st.dataframe(
                df[['Name','Type','Skill','Level','Upgradable','Steps','Achievement']],
...
def menu_tab_dashboards():
    ...
    df_a = df_a[(df_a['Skill'] == '⚔ Attack')].sort_values(by=['Skill','Level','Achievement'],ascending=False,ignore_index=False).head(7)
